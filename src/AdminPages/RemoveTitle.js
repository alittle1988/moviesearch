    ...
    <div className='removeTitle'>
        <Form>
            <Form.Group>
                ...
                <Form.Control onChange={(e) => setRemoveTitle(e.target.value)} value={removeTitle} type="text" placeholder="Title"></Form.Control>
                <Button onClick={() => removeTitleFunc(removeTitle)} type='button' variant='primary' style={{marginTop: 20}}>Submit</Button>
            </Form.Group>
        </Form>
    </div>
  )
